      ...
      <header className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate">{fmtElapsed(elapsed)}</span>
          </div>
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <button className="rounded-md bg-navy-900 px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-navy-800">
            Barge in
          </button>
        </div>
      </header>
